...
DATA_DIR = "../Datasets/all_vectors_prev_window_label.csv"
...
train_inputs,train_labels = utils.convert_data_to_arrays(train)
test_inputs,test_labels = utils.convert_data_to_arrays(test)
